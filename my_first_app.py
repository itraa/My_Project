...
from create_strain import *
from create_mice_list import *
...
app.add_url_rule('/create_strain/',
                view_func=create_strain.as_view('create_strain'), 
                methods=['GET','POST'])

app.add_url_rule('/create_mice_list/',
                view_func=create_mice_list.as_view('create_mice_list'), 
                methods=['GET','POST'])
