...
class Breeding(db.Model):
    ...
    Male_DOB = db.Column(db.String(8))
    Female1_Tag = db.Column(db.String(100))
    Female1_DOB = db.Column(db.String(8))
    Female2_Tag = db.Column(db.String(100))
    Female2_DOB = db.Column(db.String(8))
    Date_Setup = db.Column(db.String(8))
    Date_Pups_Born = db.Column(db.String(8))
    ...
    def __repr__(self):
        return "<Breeding(%s, %s, %x, %s, %x, %s, %x, %x, %x'>" % (self.Breeding_Cage_Id, self.Male_Tag, self.Male_DOB, self.Female1_Tag, self.Female1_DOB,
